...
namespace BungieLoginApp.DAL
{
    public class BungieClient : INotifyPropertyChanged
    {
        ...
        public const string AuthenticationCodeRequest = "https://www.bungie.net/en/Application/Authorize/11093"; //todo: Replace with your own Auth url.
        private const int Success = 1;
        private const string ApiKey = "9681c0a6c9f44315bef80e15a4e3b469"; //todo: Replace with your own ApiKey.
